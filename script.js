...
defender1.src = 'images/PNG/defender1.png';
const defender2 = new Image();
defender2.src = 'images/PNG/defender2.png';
...
enemy1.src = 'images/PNG/enemy1.png';
enemyTypes.push(enemy1);
const enemy2 = new Image();
enemy2.src = 'images/PNG/enemy2.png';
...
function handleEnemies(){
    for (let i = 0; i < enemies.length; i++){
        ...
        if (enemies[i].health <= 0){
            ...
            floatingMessages.push(new floatingMessage('+' + gainedResources, enemies[i].x,
            enemies[i].y, 30, 'black'));
